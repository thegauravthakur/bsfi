...
const Header = () => {
  return (
    <div className="px-4 sm:px-10 xl:px-32 py-4 lg:flex lg:justify-between my-5 md:my-10 ">
      <div className="self-center max-w-2xl md:text-center lg:text-left md:mx-auto md: mx-0 ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-10 sm:max-w-sm  md:max-w-md lg:max-w-xl md:mx-auto lg:mx-0 ">
          <button className="focus:outline-none px-8 py-3 bg-blue-600 text-white text-xl rounded-md">
            Our Products
          </button>
          <button className="focus:outline-none px-8 py-3 bg-blue-600 text-white text-xl rounded-md">
            Contact Us
      ...
      <div className="self-center max-w-2xl text-center lg:text-left mx-auto mx-0 mt-16 ">
        <Image
          height={400}
          width={500}
